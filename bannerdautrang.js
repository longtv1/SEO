...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='http://bigsea.vn/' target='_blank'><img src='http://www.upsieutoc.com/image/q00buw' width='500px'/><br/>Thiết bị vệ sin giá rẻ</a>. Liên hệ: 0976 173 468 <h2><a class='close-linhnguyen-modal'>X</a></h2>");
